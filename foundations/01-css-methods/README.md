...
- Did you properly link the external CSS file in the HTML file? - Yes, at first, no because I don't know that rel should only be stylesheet, I tried style first. but I was ultimately able to make it
